...
function GoToTarget(x, y, z, vehicle, driver, vehhash, target)
    ...
    ShowAdvancedNotification(companyIcon, companyName, "Mecânico solicitado", "Um mecânico foi enviado, obrigado por usar  ~y~" .. companyName)
    enroute = true
    while enroute do
        Citizen.Wait(500)
...
function GetTargetVehicle(player, dir)
    ...
    if DoesEntityExist(dmgVeh) then
        ...
        ShowNotification("Falha ao encontrar o veiculo.")
    end
end
