		...
		if not processo then
			for _,func in pairs(arvores) do
				...
				if distancia <= 50 and list[i] == nil then
					DrawMarker(21,x,y,z,0,0,0,0,180.0,130.0,0.5,0.5,0.5,255,0,0,50,1,0,0,1)
					if distancia <= 1.2 and GetEntityModel(vehicle) == -667151410 then
						drawTxt("PRESSIONE  ~r~E~w~  PARA CORTAR MADEIRA",4,0.5,0.93,0.50,255,255,255,180)
