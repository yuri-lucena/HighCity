...
local servico = false
local selecionado = 0
local CoordenadaX = 175.00
local CoordenadaY = -27.18
local CoordenadaZ = 68.37
local quantidade = 0
-----------------------------------------------------------------------------------------------------------------------------------------
-- RESIDENCIAS
-----------------------------------------------------------------------------------------------------------------------------------------
	...
	while true do
		...
		if servico then
			...
			if distance <= 3 and GetEntityModel(vehicle) == 1026149675 then
				...
				if distance <= 1.2 then
					drawTxt("PRESSIONE  ~r~G~w~  PARA ENTREGAR AS GARRAFAS DE LEITE",4,0.5,0.93,0.50,255,255,255,180)
