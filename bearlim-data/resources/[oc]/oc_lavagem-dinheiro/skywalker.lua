...
function oC.checkPermissao()
    ...
    if vRP.hasPermission(user_id,"odebrecht.permissao") or vRP.hasPermission(user_id,"diretor-odebrecht.permissao") or vRP.hasPermission(user_id,"lider-bratva") or vRP.hasPermission(user_id,"bratva.permissao") or vRP.hasPermission(user_id,"anonymous.permissao") then
        return true
    end
end