...
local itemlist = {
	...
	["costura"] = { index = "costura", nome = "Costura"},
	["panoduro"] = { index = "panoduro", nome = "Pano Duro"},
	---------------------------------------------------------------------------------------------------
...
local salarios = {
	...
	{ ['permissao'] = "bronze.permissao", ['nome'] = "Donate Bronze", ['payment'] = 2500 },
	{ ['permissao'] = "prata.permissao", ['nome'] = "Donate Prata", ['payment'] = 5000},
	{ ['permissao'] = "ouro.permissao", ['nome'] = "Donate Ouro", ['payment'] = 7500},
	{ ['permissao'] = "platina.permissao", ['nome'] = "Donate Platina", ['payment'] = 10000},
	{ ['permissao'] = "black.permissao", ['nome'] = "Donate Black", ['payment'] = 15000}
}
...
RegisterCommand('call',function(source,args,rawCommand)
	...
	if user_id then
		...
		elseif args[1] == "adm" then
			players = vRP.getUsersByPermission("call.permissao")	
