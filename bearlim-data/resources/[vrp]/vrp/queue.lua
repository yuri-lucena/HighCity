...
Config.Language = {
	joining = "[HighCity] Entrando...",
	connecting = "[HighCity] Conectando...",
	err = "[HighCity] Não foi possível identificar sua Steam ou Social Club.",
	_err = "[HighCity] Você foi desconectado por demorar demais na fila.",
	pos = "[HighCity] Você é o %d/%d da fila, aguarde sua conexão",
	connectingerr = "[HighCity] Não foi possível adiciona-lo na fila.",
    wlonly = "[HighCity] Você não está aprovado na whitelist.",
	banned = "[HighCity] Seu passaporte foi revogado na cidade.",
	steam = "[HighCity] Você precisa estar com a Steam aberta para conectar."
}
