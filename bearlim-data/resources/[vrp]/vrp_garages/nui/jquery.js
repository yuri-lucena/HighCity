        ...
        $('#garagem').html(`
            ...
            ${nameList.map((item) => (`
							<div class="item" data-item-name="${item.name}">
												<div class="item-img">
													<img src="http://8.9.37.88/imgnoxcity233223/${item.name}.png" class="img">
												</div>
							                    <div class="item-text">
							                    ...
							                    <div class="item-text">
							                        <div class="item-right">Motor: ${item.engine}% | Lataria: ${item.body}% | Gasolina: ${item.fuel}%</div>
							                    </div>
							                   <div class="item-text" style="border: 0;">

							                        <div class="item-right">IPVA: <b>${item.ipva}</b></div>
							                    </div>
							                    <div class="item-text" style="border: 0;">
							                        <div class="item-left">Liberação:</b>${item.status} </div>
