...
-----------------------------------------------------------------------------------------------------------------------------------------
	[16] = { ['name'] = "DPLA", ['payment'] = false, ['perm'] = "dpla.permissao" },
	[17] = { ['name'] = "DPLA", ['payment'] = false, ['perm'] = "dpla.permissao" },
	[18] = { ['name'] = "DPLAH", ['payment'] = false, ['perm'] = "dpla.permissao" },
-----------------------------------------------------------------------------------------------------------------------------------------
--[ DEPARTAMENTO MÉDICO ]----------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
	[19] = { ['name'] = "DMLA", ['payment'] = false, ['perm'] = "dmla.permissao" },
-----------------------------------------------------------------------------------------------------------------------------------------
---[ FORTHILLS ]-------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------------------------------------------------
	...
	[610] = { ['name'] = "Taxi", ['payment'] = false, ['public'] = true },
	[20] = { ['name'] = "Lixeiro", ['payment'] = false, ['public'] = true },
	[21] = { ['name'] = "Concessionaria", ['payment'] = false, ['perm'] = "administrador.permissao"},
	[614] = { ['name'] = "Minerador", ['payment'] = false, ['public'] = true },
	[612] = { ['name'] = "Caminhoneiro", ['payment'] = false, ['public'] = true }
}
-----------------------------------------------------------------------------------------------------------------------------------------
--[ GARAGEMS ]---------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
	...
	if user_id then
		...
		if vehicle and placa then
			...
			if user_id == placa_user_id then
				...
				TriggerClientEvent("vrp_sound:source",source,'lock',1.5)
