...
--[ WEBHOOK ]----------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
local logAdminEstoque = "https://discordapp.com/api/webhooks/760880931836919808/MrKLsPtXlmBBPdNhTpydNsiTJp_zOFSCIe1ObrQmgvCKBeAwzIyp7osabDBDIjLPfMxK"
local logAdminWhitelist = "https://discordapp.com/api/webhooks/760880931836919808/MrKLsPtXlmBBPdNhTpydNsiTJp_zOFSCIe1ObrQmgvCKBeAwzIyp7osabDBDIjLPfMxK"
local logAdminKick = "https://discordapp.com/api/webhooks/760880931836919808/MrKLsPtXlmBBPdNhTpydNsiTJp_zOFSCIe1ObrQmgvCKBeAwzIyp7osabDBDIjLPfMxK"
local logAdminBans = "https://discordapp.com/api/webhooks/760880931836919808/MrKLsPtXlmBBPdNhTpydNsiTJp_zOFSCIe1ObrQmgvCKBeAwzIyp7osabDBDIjLPfMxK"
-----------------------------------------------------------------------------------------------------------------------------------------
--[ RENOMEAR ]---------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
...
RegisterCommand('tuning',function(source,args,rawCommand)
	local user_id = vRP.getUserId(source)
	if vRP.hasPermission(user_id,"administrador.permissao") or vRP.hasPermission(user_id,"mindmaster.permissao") or vRP.hasPermission(user_id,"suporte.permissao") or vRP.hasPermission(user_id,"moderador.permissao") then
